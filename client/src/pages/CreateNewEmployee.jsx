        ...
        <form onSubmit={handleFormSubmit}>
            <div className="grid gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="username" className="bg-gray-50 outline-none border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5    " placeholder="John"  onChange={handleChagne} />
                </div>
                ...
                <div>
                    ...
                    <select id="role" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " onChange={handleChagne}>
            ...
            <div className="mb-6">
                ...
                <input type="email" id="email" className="bg-gray-50 outline-none border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5    " placeholder="john.doe@company.com"  onChange={handleChagne} />
            </div> 
            <div className="mb-6">
                <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 ">Password</label>
                <div className='flex items-center justify-between bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500   w-full p-2.5     '>
            ...
            <button type="submit" className="text-white bg-[#E6A4B4] p-2 rounded-lg hover:bg-[#D28A9E] hover:shadow-lg hover:text-black hover:scale-105 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Create</button>
        </form>
    </div>
  )
}
